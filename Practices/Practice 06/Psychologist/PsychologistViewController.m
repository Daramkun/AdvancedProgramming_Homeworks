...
- (void) showDiagnosis:(int) diagnosis
{
    ViewController * happinessViewController = self.viewController;
    happinessViewController.happiness = diagnosis;
    [self.navigationController pushViewController:happinessViewController animated:TRUE];
